...
var SignupDto = function () {
    ...
    var _BNCOrderKey_decorators;
    var _BNCOrderKey_initializers = [];
    var _BNCAPIKey_decorators;
    var _BNCAPIKey_initializers = [];
    return _a = /** @class */ (function () {
            function SignupDto() {
                ...
                this.BNCOrderKey = __runInitializers(this, _BNCOrderKey_initializers, void 0);
                this.BNCAPIKey = __runInitializers(this, _BNCAPIKey_initializers, void 0);
            }
            return SignupDto;
        }()),
        (function () {
            ...
            _BNCOrderKey_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
            _BNCAPIKey_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
            ...
            __esDecorate(null, null, _BNCOrderKey_decorators, { kind: "field", name: "BNCOrderKey", static: false, private: false, access: { has: function (obj) { return "BNCOrderKey" in obj; }, get: function (obj) { return obj.BNCOrderKey; }, set: function (obj, value) { obj.BNCOrderKey = value; } }, metadata: _metadata }, _BNCOrderKey_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, _BNCAPIKey_decorators, { kind: "field", name: "BNCAPIKey", static: false, private: false, access: { has: function (obj) { return "BNCAPIKey" in obj; }, get: function (obj) { return obj.BNCAPIKey; }, set: function (obj, value) { obj.BNCAPIKey = value; } }, metadata: _metadata }, _BNCAPIKey_initializers, _instanceExtraInitializers);
