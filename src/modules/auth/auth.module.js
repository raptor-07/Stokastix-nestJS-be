...
var user_module_1 = require("../db/users/user.module");
var hash_service_1 = require("./hash/hash.service");
var jwt_service_1 = require("./jwt/jwt.service");
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [user_module_1.UserModule],
            controllers: [auth_controller_1.AuthController],
            providers: [hash_service_1.HashService, jwt_service_1.JwtService],
            exports: [hash_service_1.HashService, jwt_service_1.JwtService],
        })];
