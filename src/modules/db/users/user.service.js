...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.createUser = function (username, email, password, order_hashkey, binance_api_key) {
        ...
        UserService_1.prototype.findOne = function (username) {
            return __awaiter(this, void 0, void 0, function () {
                var user, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            console.error('Error finding user:', error_1.message);
                            return [3 /*break*/, 3];
        ...
        UserService_1.prototype.updateUserKeys = function (username, order_hashkey, binance_api_key) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
